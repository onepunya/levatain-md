...
const GREETING_PHRASES = {
    pagi:  ['Semangat mulai harinya! ☀️', 'Yuk gaskeun aktivitas hari ini 💪', 'Jangan lupa sarapan dulu ya 🍳'],
    siang: ['Jangan lupa istirahat & makan siang 🍽️', 'Semoga harimu lancar terus! ✨', 'Udah makan siang belum? 😄'],
    sore:  ['Gimana harimu sejauh ini? 🌇', 'Waktunya rehat sebentar dulu ☕', 'Sore-sore enaknya santai 😌'],
    malam: ['Udah waktunya istirahat, tapi gpp eksplor dulu 🌙', 'Jangan begadang terus ya 😴', 'Malam yang tenang buat rileks ✨'],
};
